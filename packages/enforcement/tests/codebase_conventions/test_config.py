...
class TestDefaults:
    ...
    def test_default_factories_return_independent_dicts(
        ...
        assert a.future_annotations_exempt_files is not b.future_annotations_exempt_files
...
class TestOverrides:
    ...
    def test_custom_future_annotations_exempt_files(
        ...
        config = CodebaseConventionsConfig(
            repo_root=tmp_path,
            future_annotations_exempt_files=exempt,
        )
    ...
    def test_custom_return_type_exempt_files(self, tmp_path: Path) -> None:
        ...
        config = CodebaseConventionsConfig(
            repo_root=tmp_path,
            return_type_exempt_files=exempt,
        )
