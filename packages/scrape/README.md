...
flowchart LR
    ...
    subgraph Extract["Axis 2 -- extraction_strategy_type"]
        ...
        S3[per_document<br/>no shared template → chunked extraction<br/>+ grounding judge per document, no cached recipe]
