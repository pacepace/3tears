...
target "aibots-base" {
  ...
  contexts = {
    ...
    "ghcr.io/pacepace/threetears-base:v0.10.2" = "target:threetears-base"
  }
  args = {
    THREETEARS_BASE = "ghcr.io/pacepace/threetears-base:v0.10.2"
  }
  tags = [
...
target "hub" {
  ...
  contexts = {
    "ghcr.io/pacepace/aibots-base:v0.10.2" = "target:aibots-base"
  }
  args = {
    AIBOTS_BASE = "ghcr.io/pacepace/aibots-base:v0.10.2"
  }
  tags = [
