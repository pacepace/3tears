...
target "aibots-base" {
  ...
  contexts = {
    ...
    "ghcr.io/pacepace/threetears-base:v0.13.0" = "target:threetears-base"
  }
  args = {
    THREETEARS_BASE = "ghcr.io/pacepace/threetears-base:v0.13.0"
  }
  tags = [
...
target "hub" {
  ...
  contexts = {
    "ghcr.io/pacepace/aibots-base:v0.13.0" = "target:aibots-base"
  }
  args = {
    AIBOTS_BASE = "ghcr.io/pacepace/aibots-base:v0.13.0"
  }
  tags = [
